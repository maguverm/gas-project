...
if seccion == "⛽ Contratación":
    ...
    fig_bm = go.Figure()
    fig_bm.add_trace(go.Bar(name='Contratado', x=balance['periodo_str'], y=balance['gbtud_cont'], marker_color='steelblue', text=balance['gbtud_cont'].apply(lambda x: fmt(x,1)), textposition='outside', textangle=-90, textfont=dict(size=7)))
    fig_bm.add_trace(go.Bar(name='Demanda', x=balance['periodo_str'], y=balance['gbtud_dem'], marker_color='goldenrod', text=balance['gbtud_dem'].apply(lambda x: fmt(x,1)), textposition='outside', textangle=-90, textfont=dict(size=7)))
    ...
    fig_dif = go.Figure()
    fig_dif.add_trace(go.Bar(name='Diferencia (Cont - Dem)', x=balance['periodo_str'], y=balance['diferencia'], marker_color='darkorange', text=balance['label_dif'], textposition='outside', textangle=-90, textfont=dict(size=7)))
